        ...
        GuildSettings.findOne({ guild_id: interaction.guild.id }, (err, settings) => {
            ...
            if (!settings) {
                settings = new GuildSettings({
                    ...
                    currency: "£",
                    quest_approval: interaction.options.getBoolean("approval"),
                    quest_channel_id: "please set a quest channel",
                    bounty_approval: true,
                    bounty_channel_id: "please set a bounty channel"
                })
            } else {
                settings.quest_approval = interaction.options.getBoolean("approval")
            }
